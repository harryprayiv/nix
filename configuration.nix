...

{
  ...
  ##For Cardano Guild apps on Debian: build-essential pkg-config libffi-dev libgmp-dev libssl-de>
  ## for CentOS pkgconfig libffi-devel gmp-devel openssl-devel ncurses-libs ncurses-compat-libs >
