...
stdenv.mkDerivation rec {
  ...
  srcs = [
    (fetchurl {
      url = "https://github.com/harryprayiv/Juno/releases/download/${version}/Juno.tar.xz";
      sha256 = "1cghsn9qagcf1nlga5cal0aqch6hkjm5wk6ja791zxhdqy3crx1i";
    })
    (fetchurl {
      url = "https://github.com/harryprayiv/Juno/releases/download/${version}/Juno-mirage.tar.xz";
      sha256 = "0zh6bc85svmwh8qrhpn8mim0pj322x2x2i9sxnp7p1938p5z5m2b";
    })
    (fetchurl {
      url = "https://github.com/harryprayiv/Juno/releases/download/${version}/Juno-ocean.tar.xz";
      sha256 = "0m2wgmcn12dfq5badzlpzjc8792ba9hi32c79vfvqawdn1q3hrdx";
    })
    (fetchurl {
      url = "https://github.com/harryprayiv/Juno/releases/download/${version}/Juno-palenight.tar.xz";
  ...
  meta = with lib; {
    ...
    maintainers = [ maintainers.harryprayiv ];
  };
}
